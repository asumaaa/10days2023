...
public:
	...
	static void SetModel(FbxModel* model) { EnemyBullet::model = model; }
	...
	//ヒットフラグをセットする
	void SetHitFlag(bool hitFlag, int num) { EnemyBullet::hitFlag[num] = hitFlag; };
